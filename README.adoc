...
.^|headersDelimiter
^.^|-
|Specify the delimiter used to separate each header and the body.  Must match the delimiter used by the Webhook Signature Generator policy that produced the signature.
^.^| .
